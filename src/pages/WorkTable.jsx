...
import { cardList, dateList } from '../constants/selectValues'
      ...
      <SWrap>
          ...
          <SAutocompleteContainer>
            ...
            <Autocomplete
              ...
              options={dates}
              sx={{ width: 300 }}
              renderInput={(params) => <TextField {...params} label="Дата" />}
            />
          </SAutocompleteContainer>
        </SWrap>
        <STitle>Таблица фактических работ</STitle>
      </STop>
...
const dates = dateList.map(date => date.number)
